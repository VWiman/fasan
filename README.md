...
*   Lokaliseringsträning (Experiment 2) var det enskilt viktigaste steget för att tvinga modellen att lära sig se objektet "människa" korrekt.
*   Focal Loss i kombination med tröskelvärdesjustering (Experiment 4) gav den bästa balansen för praktisk tillämpning i Search and Rescue, där hög Human Recall är prioriterat utan att dränkas i falsklarm.
...
**Slutlig reflektion:**
Att utforska lokalisering och avancerade loss-funktioner var en mycket intressant väg. När vi jämför den slutgiltiga modellen med vår ursprungliga version kan vi konstatera att förbättringarna var marginella, vilket tyder på att den ursprungliga arkitekturen redan var väl anpassad för uppgiften.

Resultat för den slutgiltiga modellen:
              precision    recall  f1-score   support
